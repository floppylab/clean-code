        ...
        static void Main(string[] args)
        {
            ...
            if (d.ContainsKey(l))
            {
                ...
                while (e < 10)
                {
                    ...
                    char chr = Convert.ToChar(Console.Read());
                    ...
                    if (hit)
                    {
                        ...
                        // drawing hangman
                        Console.WriteLine();
                        if (e > 2) Console.Write("    xxxxxxxxxxxxx");
						else Console.WriteLine();

                        if (e > 3) Console.Write("    x           x");
						else if (e > 1) Console.Write("                x");
						else Console.WriteLine();
                        ...
                        if (e > 4) Console.Write("   xxx          x");
						else if (e > 1) Console.Write("                x");
						else Console.WriteLine();

                        if (e > 4) Console.Write("  xxxxx         x");
						else if (e > 1) Console.Write("                x");
						else Console.WriteLine();
                        ...
                        if (e > 5) Console.Write("    x           x");
						else if (e > 1) Console.Write("                x");
						else Console.WriteLine();

                        if (e > 7) Console.Write("  x x x         x");
						else if (e > 6) Console.Write("  x x           x");
						else if (e > 5) Console.Write("    x           x");
						else if (e > 1) Console.Write("                x");
						else Console.WriteLine();
                        ...
                        if (e > 9) Console.Write("   x x          x");
						else if (e > 8) Console.Write("   x            x");
						else if (e > 1) Console.Write("                x");
						else Console.WriteLine();
                        ...
                        if (e > 1) Console.Write("                x");
						else Console.WriteLine();

                        if (e > 1) Console.Write("                x");
						else Console.WriteLine();

                        if (e > 0) Console.Write("xxxxxxxxxxxxxxxxxxxxxxxxxxxx");
						else Console.WriteLine();
                        Console.WriteLine();
